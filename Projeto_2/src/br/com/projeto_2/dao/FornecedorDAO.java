...
public class FornecedorDAO {
    ...
    public boolean alterarFornecedor(FornecedorDTO fornecedorDTO) {
        ...
        try {
            ...
            //Somente irá atualizar a data se for o caso de  ter sido alterada, ou seja != null
            if (fornecedorDTO.getData_cad_for() != null) 
                comando += ", data_cad_for = to_date('" + data_format.format(fornecedorDTO.getData_cad_for()) + "', 'dd/mm/yyyy')";
            
            comando += " WHERE id_for = " + fornecedorDTO.getId_for();
