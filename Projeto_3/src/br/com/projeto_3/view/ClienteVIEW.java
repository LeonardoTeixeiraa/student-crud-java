...
public class ClienteVIEW extends javax.swing.JInternalFrame {
    ...
    private void preencheCampos(int id_cli) {
        try {
            ...
            if (rs.next()) {
                limpaCampos();
                nome_cli.setText(rs.getString("nome"));
                logradouro_cli.setText(rs.getString("logradouro"));
                numero_cli.setText(rs.getString("numero"));
                bairro_cli.setText(rs.getString("bairro"));
                cidade_cli.setText(rs.getString("cidade"));
                estado_cli.setSelectedItem(rs.getString("estado"));
                cep_cli.setText(rs.getString("cep"));
                cpf_cli.setText(rs.getString("cpf"));
                rg_cli.setText(rs.getString("rg"));
